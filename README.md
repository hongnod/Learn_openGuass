...
OpenGauss community released openGauss 2.0 recently, with this release, they provide a simplified package with official support Centos and OpenEuler. I trid the OpenEuler version on Debian 10 with succes, the step is:
```
